    ...
    return(
      <div className="left-content-wrapper">
        <div className="profile-content">
          ...
          <h2>{name}</h2>
          <p>{prepareString(profile.about)}</p>
